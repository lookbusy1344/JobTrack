...
public sealed class PasswordBlocklistTests
{
	...
	[InlineData("jobtrack")]
	[InlineData("JOBTRACK")]
	public void Contains_blocks_the_product_name_regardless_of_case(string password) => PasswordBlocklist.Contains(password).Should().BeTrue();
	...
	[Fact]
	public void Contains_blocks_a_known_common_password() => PasswordBlocklist.Contains("correcthorsebatterystaple").Should().BeTrue();
