...
public sealed class SqliteInitialisedMarkerSchemaTests()
	: InitialisedMarkerSchemaContractTestsBase(new SqliteDatabaseFixture())
{
	...
	protected override object EncodeInitialisedAt(DateTimeOffset value) => value.UtcDateTime.Ticks - DateTime.UnixEpoch.Ticks;
}
