...
public sealed class SqliteScheduleVersionSchemaTests()
	: ScheduleVersionSchemaContractTestsBase(new SqliteDatabaseFixture())
{
	...
	protected override object EncodeDate(DateOnly value) => value.ToString("yyyy-MM-dd", CultureInfo.InvariantCulture);

	protected override object EncodeTimeOfDay(TimeOnly value) => value.Ticks;
}
