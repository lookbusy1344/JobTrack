...
public sealed class SqliteJobRequestSchemaTests()
	: JobRequestSchemaContractTestsBase(new SqliteDatabaseFixture())
{
	...
	protected override object EncodeBoolean(bool value) => value ? 1L : 0L;
}
