...
public sealed class PostgreSqlJobRequestSchemaTests()
	: JobRequestSchemaContractTestsBase(new PostgreSqlDatabaseFixture())
{
	...
	protected override object EncodeBoolean(bool value) => value;
}
