...
public sealed class OpenApiContractTests : IAsyncLifetime, IDisposable
{
	...
	private static readonly OperationContract[] ExpectedContract = [
		...
		new(
			"POST", "/api/jobs/{nodeId}/sessions/{sessionId}/finish-and-update-write-up",
		...
		new("GET", "/api/jobs/{nodeId}/cost", ["400", "401", "403", "404", "422", "429"]),
		new("GET", "/api/jobs/{nodeId}/cost/hierarchy", ["400", "401", "403", "404", "422", "429"]),
