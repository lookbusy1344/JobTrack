...
/// <summary>
///     SQLite implementation of <see cref="IScheduleQueryPort" /> (plan §8.5 slice 6). One
///     <see cref="SqliteJobTrackDbContext" /> per call, read-only throughout.
/// </summary>
internal sealed class SqliteScheduleQueryPort : IScheduleQueryPort
{
	private readonly string connectionString;

	/// <summary>Creates the port over the given SQLite connection string.</summary>
	public SqliteScheduleQueryPort(string connectionString) => this.connectionString = connectionString;
