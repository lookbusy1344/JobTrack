...
/// <summary>
///     The provider-neutral body of <see cref="IScheduleQueryPort" /> (plan §8.5 slice 6). One
///     <see cref="DbContext" /> per call, read-only throughout.
/// </summary>
internal sealed class ScheduleQueryPort(IProviderReadOperations provider, IClock clock) : IScheduleQueryPort
{
	/// <inheritdoc />
