...
/// <summary>
///     The provider-neutral body of <see cref="IAuditQueryPort" /> (impl plan §7.3/§7.4 slice 11:
...
/// </summary>
internal sealed class AuditQueryPort(IProviderReadOperations provider, IClock clock) : IAuditQueryPort
{
	/// <inheritdoc />
...
/// <summary>
///     The audit-search assembly logic behind <see cref="AuditQueryPort" />, mirrored
