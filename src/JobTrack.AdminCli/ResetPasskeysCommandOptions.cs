...
/// <summary>Parsed arguments for the <c>reset-passkeys</c> CLI command.</summary>
public sealed record ResetPasskeysCommandOptions
{
	...
	/// </summary>
	public static ResetPasskeysCommandOptions Parse(PicoArgs pico)
	{
