...
/// <summary>Parsed arguments for the <c>reset-password</c> CLI command.</summary>
public sealed record ResetPasswordCommandOptions
{
	...
	/// </summary>
	public static ResetPasswordCommandOptions Parse(PicoArgs pico)
	{
