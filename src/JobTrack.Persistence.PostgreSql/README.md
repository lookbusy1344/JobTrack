...
PostgreSQL implementation of `JobTrack.Application`'s persistence ports using EF Core and
Npgsql. `DbContext`, entity configurations, and provider extensions are internal.
