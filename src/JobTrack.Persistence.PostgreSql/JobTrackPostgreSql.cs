...
public static class JobTrackPostgreSql
{
	...
	///     <see
	///         cref="CreateWithPatDataSources(NpgsqlDataSource, NpgsqlDataSource, NpgsqlDataSource, Microsoft.AspNetCore.Identity.IPasswordHasher{JobTrack.Application.BootstrapCredentialSubject}?, Microsoft.AspNetCore.Identity.IPasswordHasher{JobTrack.Application.EmployeeCredentialSubject}?, IClock?, ILoggerFactory?)" />
