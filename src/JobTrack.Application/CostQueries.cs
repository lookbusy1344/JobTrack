...
internal sealed partial class CostQueries : ICostQueries, IRequesterDurationQueries
{
	...
	private void LogGrowthSignal(
		CostReadOperation operation, EquatableArray<WorkerCostInputs> workers, WorkInterval bounds,
	...
	private static partial void LogCostReadGrowthSignal(
		ILogger logger, CostReadOperation operation, long dbMs, long engineMs, long windowTicks, int workers, int sessionsTotal, int sessionsMax,
		int sessionsP50,
		int sessionsP95);
