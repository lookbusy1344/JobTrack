...
/// <summary>Result of <see cref="IInstallationCommands.BootstrapAdministratorAsync" />.</summary>
public sealed record BootstrapAdministratorResult
{
	...
	/// <summary>The new administrator's optimistic-concurrency version, for subsequent profile edits.</summary>
