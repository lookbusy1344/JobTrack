...
| [`2026-07-23-architecture-boundary-remediation-plan.md`](2026-07-23-architecture-boundary-remediation-plan.md) | Proposed | Fresh-eyes architecture review: move split work-ending and password-change workflows behind atomic library commands, tighten the public SPI and EF boundary, and add one-intent/one-mutation guardrails. |
