...
| [`2026-07-28-fresh-eyes-code-review-remediation-plan.md`](2026-07-28-fresh-eyes-code-review-remediation-plan.md) | Proposed | Fresh-eyes review: achievement-reopen serialization, blocked-query fan-out, deterministic performance gates, fast-suite budget enforcement, principal-bound filter state, and immutable test guardrails. |
