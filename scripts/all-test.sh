...
# run above silently skips it (README's "Performance lane", §2.3 of the 2026-07-28 fresh-eyes review --
...
# closing commit), not the per-commit gate (see CLAUDE.md/README's "Fast core suite").
set -euo pipefail
